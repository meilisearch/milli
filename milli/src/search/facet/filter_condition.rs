...
use crate::{CboRoaringBitmapCodec, FieldId, FieldsIdsMap, Index};

use super::parser::Rule;
use super::parser::{FilterParser, PREC_CLIMBER};
...
impl FilterCondition {
    ...
    fn from_pairs(
        ...
        PREC_CLIMBER.climb(
            ...
            |lhs: anyhow::Result<Self>, op: Pair<Rule>, rhs: anyhow::Result<Self>| match op
                .as_rule()
            {
...
impl FilterCondition {
    ...
    pub fn evaluate(&self, rtxn: &heed::RoTxn, index: &Index) -> anyhow::Result<RoaringBitmap> {
